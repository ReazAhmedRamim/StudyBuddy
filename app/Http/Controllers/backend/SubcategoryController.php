...
class SubcategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tutor.subcategory.index', compact('all_subcategories'));
    }
    ...
    public function create()
    {
        ...
        return view('tutor.subcategory.create', compact('all_categories'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('btutor.subcategory.edit', compact('sub_category', 'all_categories'));
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('tutor.subcategory.index')->with('success', 'SubCategory deleted successfully.');
    }
}
