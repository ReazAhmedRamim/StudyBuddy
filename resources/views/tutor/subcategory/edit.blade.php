...
@section('content')
    <div class="page-content">
        ...
        @include('tutor.section.breadcrumb', ['title'=> 'SubCategory', 'sub_title'=> 'Insert-SubCategory']);
            ...
            <div class="card-body">
                ...
                <div class="card-body p-4">
                    ...
                    <div style="display: flex; align-items:center; justify-content:space-between">
                        ...
                        <a href="{{ route('tutor.subcategory.index') }}" class="btn btn-primary">Back</a>
                    ...
                    <!-- <form class="row g-3" method="post" action="{{ route('tutor.subcategory.update', $sub_category->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="col-md-6">
