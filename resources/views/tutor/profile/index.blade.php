                    ...
                    <div class="card">
                        <form action="{{ route('tutor.profile.update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0">Teaching Mode</h6>
                                    </div>
                                    <div class="col-sm-9 text-secondary">
                                        <select name="teaching_mode" class="form-select">
                                            <option value="online" {{ auth()->user()->teaching_mode == 'online' ? 'selected' : '' }}>Online</option>
                                            <option value="offline" {{ auth()->user()->teaching_mode == 'offline' ? 'selected' : '' }}>Offline</option>
                                            <option value="both" {{ auth()->user()->teaching_mode == 'both' ? 'selected' : '' }}>Both</option>
                                        </select>
                                    </div>
                                </div>
